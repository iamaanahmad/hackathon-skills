...
This adapter is only for discovery while working in this repository. For installation or redistribution, copy the complete `hackathon-grand-prize/` directory into one supported skill location; do not copy this adapter alone.
